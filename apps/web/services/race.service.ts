...
export const raceService = {
  ...
  matchmake: (body: { mode: RaceMode; wordCount: 25 | 50 | 100; numbers: boolean; punctuation: boolean; inviteCode?: string }) => postJson<MultiplayerState>("/api/multiplayer/matchmake", body),
