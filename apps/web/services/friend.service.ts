...
export type RaceOptions = { mode: RaceMode; wordCount: 25 | 50 | 100; playerCount: 2 | 3; numbers: boolean; punctuation: boolean };
...
export const friendService = {
  ...
  respond: (code: string, action: "accept" | "reject" | "cancel") => postJson<{ status: string; code?: string; options?: RaceOptions }>(`/api/friends/invites/${code}/${action}`, {}),
