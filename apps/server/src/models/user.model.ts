...
const legacyResultSchema = new Schema({ speed:Number,accuracy:Number,errors:Number,category:String,subCategory:String,time:Number,date:{type:Date,default:Date.now} });
